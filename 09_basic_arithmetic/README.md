...
**One-hot кодирование** — это способ представления состояний конечного автомата или других логических сущностей, при котором *только один* бит в регистре находится в состоянии `1`, а остальные — в `0`.

Пример для автомата из 4 состояний:
```
